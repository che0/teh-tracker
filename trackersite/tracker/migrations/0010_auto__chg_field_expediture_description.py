...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Expediture.description'
        db.alter_column('tracker_expediture', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Expediture.description'
        db.alter_column('tracker_expediture', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
