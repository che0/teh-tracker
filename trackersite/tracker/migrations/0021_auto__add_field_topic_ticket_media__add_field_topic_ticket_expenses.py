...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Topic.ticket_media'
        db.add_column('tracker_topic', 'ticket_media', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Topic.ticket_expenses'
        db.add_column('tracker_topic', 'ticket_expenses', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.ticket_media'
        db.delete_column('tracker_topic', 'ticket_media')

        # Deleting field 'Topic.ticket_expenses'
        db.delete_column('tracker_topic', 'ticket_expenses')
