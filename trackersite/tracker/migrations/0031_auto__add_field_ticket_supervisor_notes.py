...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.supervisor_notes'
        db.add_column('tracker_ticket', 'supervisor_notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.supervisor_notes'
        db.delete_column('tracker_ticket', 'supervisor_notes')
