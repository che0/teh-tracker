...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.requested_user'
        db.add_column('tracker_ticket', 'requested_user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True), keep_default=False)

        # Adding field 'Ticket.requested_text'
        db.add_column('tracker_ticket', 'requested_text', self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.requested_user'
        db.delete_column('tracker_ticket', 'requested_user_id')

        # Deleting field 'Ticket.requested_text'
        db.delete_column('tracker_ticket', 'requested_text')
