...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cluster.total_tickets'
        db.add_column('tracker_cluster', 'total_tickets', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True), keep_default=False)

        # Adding field 'Cluster.total_transactions'
        db.add_column('tracker_cluster', 'total_transactions', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cluster.total_tickets'
        db.delete_column('tracker_cluster', 'total_tickets')

        # Deleting field 'Cluster.total_transactions'
        db.delete_column('tracker_cluster', 'total_transactions')
