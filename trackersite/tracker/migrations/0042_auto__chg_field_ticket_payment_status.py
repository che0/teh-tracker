...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ticket.payment_status'
        db.alter_column('tracker_ticket', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Ticket.payment_status'
        db.alter_column('tracker_ticket', 'payment_status', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
