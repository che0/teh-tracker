...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('tracker_ticket', 'status')
    ...
    def backwards(self, orm):
        ...
        db.add_column('tracker_ticket', 'status', self.gf('django.db.models.fields.CharField')(default='X', max_length=100), keep_default=False)
