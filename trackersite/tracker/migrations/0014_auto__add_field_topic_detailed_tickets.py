...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Topic.detailed_tickets'
        db.add_column('tracker_topic', 'detailed_tickets', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.detailed_tickets'
        db.delete_column('tracker_topic', 'detailed_tickets')
