...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_document', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Ticket'])),
            ('filename', self.gf('django.db.models.fields.CharField')(max_length=120)),
        ...
        db.send_create_signal('tracker', ['Document'])


    def backwards(self, orm):
        
        # Deleting model 'Document'
        db.delete_table('tracker_document')
