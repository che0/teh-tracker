...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Topic.form_description'
        db.add_column('tracker_topic', 'form_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Topic.form_description'
        db.delete_column('tracker_topic', 'form_description')
