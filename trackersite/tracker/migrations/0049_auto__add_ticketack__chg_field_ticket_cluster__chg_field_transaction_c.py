...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TicketAck'
        db.create_table('tracker_ticketack', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ticket', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Ticket'])),
            ('ack_type', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ...
        db.send_create_signal('tracker', ['TicketAck'])


        # Changing field 'Ticket.cluster'
        db.alter_column('tracker_ticket', 'cluster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Cluster'], null=True, on_delete=models.SET_NULL))

        # Changing field 'Transaction.cluster'
        db.alter_column('tracker_transaction', 'cluster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Cluster'], null=True, on_delete=models.SET_NULL))

    def backwards(self, orm):
        # Deleting model 'TicketAck'
        db.delete_table('tracker_ticketack')


        # Changing field 'Ticket.cluster'
        db.alter_column('tracker_ticket', 'cluster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Cluster'], null=True))

        # Changing field 'Transaction.cluster'
        db.alter_column('tracker_transaction', 'cluster_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Cluster'], null=True))
