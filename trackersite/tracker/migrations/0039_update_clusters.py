...
class Migration(DataMigration):
    ...
    models = {
        ...
        'tracker.cluster': {
            ...
            'total_tickets': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'}),
            'total_transactions': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '2'})
        },
        'tracker.expediture': {
