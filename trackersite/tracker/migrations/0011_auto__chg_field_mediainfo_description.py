...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'MediaInfo.description'
        db.alter_column('tracker_mediainfo', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'MediaInfo.description'
        db.alter_column('tracker_mediainfo', 'description', self.gf('django.db.models.fields.CharField')(max_length=100))
