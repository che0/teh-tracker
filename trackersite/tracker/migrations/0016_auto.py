...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field admin on 'Topic'
        db.create_table('tracker_topic_admin', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('topic', models.ForeignKey(orm['tracker.topic'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('tracker_topic_admin', ['topic_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field admin on 'Topic'
        db.delete_table('tracker_topic_admin')
