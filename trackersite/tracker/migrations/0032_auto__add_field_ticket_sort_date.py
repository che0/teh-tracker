...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.sort_date'
        db.add_column('tracker_ticket', 'sort_date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2000, 1, 1)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.sort_date'
        db.delete_column('tracker_ticket', 'sort_date')
