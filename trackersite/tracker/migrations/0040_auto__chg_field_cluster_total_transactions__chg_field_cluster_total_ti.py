...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cluster.total_transactions'
        db.alter_column('tracker_cluster', 'total_transactions', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

        # Changing field 'Cluster.total_tickets'
        db.alter_column('tracker_cluster', 'total_tickets', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))


    def backwards(self, orm):
        
        # Changing field 'Cluster.total_transactions'
        db.alter_column('tracker_cluster', 'total_transactions', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'Cluster.total_tickets'
        db.alter_column('tracker_cluster', 'total_tickets', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
