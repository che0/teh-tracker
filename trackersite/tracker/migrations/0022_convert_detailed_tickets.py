...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for topic in orm.Topic.objects.all():
            topic.ticket_media = topic.detailed_tickets
            topic.ticket_expenses = topic.detailed_tickets
            topic.save()

    def backwards(self, orm):
        for topic in orm.Topic.objects.all():
            topic.detailed_tickets = topic.ticket_media or topic.ticket_expenses
            topic.save()
