...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_userprofile', (
            ...
            ('bank_account', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
            ('other_contact', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
            ('other_identification', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
        ))
