...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Expediture.accounting_info'
        db.add_column('tracker_expediture', 'accounting_info', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Expediture.accounting_info'
        db.delete_column('tracker_expediture', 'accounting_info')
