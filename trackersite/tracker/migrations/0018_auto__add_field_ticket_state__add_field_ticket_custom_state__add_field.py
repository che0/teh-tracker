...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ticket.state'
        db.add_column('tracker_ticket', 'state', self.gf('django.db.models.fields.CharField')(default='X', max_length=20), keep_default=False)

        # Adding field 'Ticket.custom_state'
        db.add_column('tracker_ticket', 'custom_state', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Ticket.rating_percentage'
        db.add_column('tracker_ticket', 'rating_percentage', self.gf('tracker.models.PercentageField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Ticket.state'
        db.delete_column('tracker_ticket', 'state')

        # Deleting field 'Ticket.custom_state'
        db.delete_column('tracker_ticket', 'custom_state')

        # Deleting field 'Ticket.rating_percentage'
        db.delete_column('tracker_ticket', 'rating_percentage')
    ...
    models = {
        ...
        'tracker.topic': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'detailed_tickets': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
