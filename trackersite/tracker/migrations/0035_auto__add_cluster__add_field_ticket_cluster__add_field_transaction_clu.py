...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tracker_cluster', (
            ('id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('more_tickets', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('tracker', ['Cluster'])

        # Adding field 'Ticket.cluster'
        db.add_column('tracker_ticket', 'cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Cluster'], null=True, blank=True), keep_default=False)

        # Adding field 'Transaction.cluster'
        db.add_column('tracker_transaction', 'cluster', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tracker.Cluster'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Cluster'
        db.delete_table('tracker_cluster')

        # Deleting field 'Ticket.cluster'
        db.delete_column('tracker_ticket', 'cluster_id')

        # Deleting field 'Transaction.cluster'
        db.delete_column('tracker_transaction', 'cluster_id')
