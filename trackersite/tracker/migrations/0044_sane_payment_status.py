...
class Migration(DataMigration):
    ...
    def change(self, orm, a, b):
        for t in orm.Ticket.objects.filter(payment_status=a):
            t.payment_status = b
            t.save()
    
    def forwards(self, orm):
        self.change(orm, 'n/a', 'n_a')
        self.change(orm, 'partially paid', 'partially_paid')

    def backwards(self, orm):
        self.change(orm, 'n_a', 'n/a')
        self.change(orm, 'partially_paid', 'partially paid')
