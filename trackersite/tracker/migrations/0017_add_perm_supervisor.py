...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(model='topic', app_label='tracker')
        perm, created = orm['auth.permission'].objects.get_or_create(content_type=ct, codename='supervisor')
        if created:
            perm.name=u'Can edit all topics and tickets'
            perm.save()
