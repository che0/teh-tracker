...
urlpatterns = patterns('',
    ...
    url(r'^password/change/done/$', auth.password_change_done, kwargs={'template_name':'users/password_change_done.html'}),
    ...
    url(r'^password/reset/sent/$', auth.password_reset_done, kwargs={'template_name':'users/password_reset_done.html'}),
    url(r'^password/reset/(?P<uidb36>[^/]+)/(?P<token>[^/]+)/$', auth.password_reset_confirm, kwargs={
            'template_name':'users/password_reset_confirm.html'
        }),
    url(r'^password/reset/done/$', auth.password_reset_complete, kwargs={
